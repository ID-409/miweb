 ...
 * @description Singleton class that handles the <b>timing of test</b> and
...
cafe cafe cafe cafe cafe cafe1
cafe cafe cafe cafe cafe cafe2
cafe cafe cafe cafe cafe cafe3
	/**
...
const ExampleIntervalTimer = function (output = v => console.log(v)) {
	...
	// ... Initialization code ...
	// I generally use it for timing test in Jasmine JS.
	...
	/**
	 * Return the elapsed time and resets the timer to O.
	 */
